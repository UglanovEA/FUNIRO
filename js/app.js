...
*/
    ...
    window.onload = function() {
        ...
        sr.reveal(`.rooms__body, .main-slider__content`, {
            origin: "left"
        });
        sr.reveal(`.furniture__title`, {
            delay: 200
        });
        sr.reveal(`.header__menu, .menu-footer__column, .products__item, .advantages__item`, {
            delay: 200,
            interval: 100
        });
        ...
        sr.reveal(`.actions-header__item_favorites, .footer__subscribe`, {
            delay: 400
        });
        sr.reveal(`.cart-header__icon`, {
            delay: 500
        });
        sr.reveal(`.actions-header__item_user`, {
            delay: 600
        });
    };
    window["FLS"] = true;
